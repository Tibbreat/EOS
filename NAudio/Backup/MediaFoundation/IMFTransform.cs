...
// Type: NAudio.MediaFoundation.IMFTransform
...
namespace NAudio.MediaFoundation
{
  ...
  public interface IMFTransform
  {
    ...
    void GetStreamIds(
      [In] int dwInputIDArraySize,
      [In, Out] int[] pdwInputIDs,
      [In] int dwOutputIDArraySize,
    ...
    int ProcessOutput(
      [In] _MFT_PROCESS_OUTPUT_FLAGS dwFlags,
      [In] int cOutputBufferCount,
      [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), In, Out] MFT_OUTPUT_DATA_BUFFER[] pOutputSamples,
      out _MFT_PROCESS_OUTPUT_STATUS pdwStatus);
  }
}
