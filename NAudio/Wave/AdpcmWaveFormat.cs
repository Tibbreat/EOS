...
namespace NAudio.Wave
{
  ...
  public class AdpcmWaveFormat : WaveFormat
  {
    ...
    {
      return string.Format("Microsoft ADPCM {0} Hz {1} channels {2} bits per sample {3} samples per block", (object) this.SampleRate, (object) this.channels, (object) this.bitsPerSample, (object) this.samplesPerBlock);
    }
  }
}
