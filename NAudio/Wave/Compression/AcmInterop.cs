...
namespace NAudio.Wave.Compression
{
  internal class AcmInterop
  {
    ...
    public static extern MmResult acmFormatSuggest(
      IntPtr hAcmDriver,
      [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (WaveFormatCustomMarshaler)), In] WaveFormat sourceFormat,
      [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (WaveFormatCustomMarshaler)), In, Out] WaveFormat destFormat,
      int sizeDestFormat,
    ...
    public static extern MmResult acmStreamOpen(
      ...
      IntPtr hAcmDriver,
      [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (WaveFormatCustomMarshaler)), In] WaveFormat sourceFormat,
      [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (WaveFormatCustomMarshaler)), In] WaveFormat destFormat,
